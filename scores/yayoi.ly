...
\score {
  \new PianoStaff <<
    \new Staff {
      ...
      | <e a>8 <fis b> <gis b> ~ <gis cis'> <a e'>4 ~ <a dis'> ~ <gis dis' gis'> ~ <gis cis' gis'> <ais ais'> <b b'>
      | \time 4/4
      ...
      | <fis' gis' fis''> <e' b' e''> <dis' g' dis''>8 ~ <cis' g' cis''> <b b'> ~ <cis' b' cis''> <dis' fis' dis''>4 <fis' b' fis''> <ais' d'' ais''> <gis' f'' gis''>
      | <b' e'' b''>2.
    }
    \new Staff {
      \clef bass
